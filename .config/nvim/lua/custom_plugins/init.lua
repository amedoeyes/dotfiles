local fe = require("custom_plugins.file_explorer")
...
local term = require("custom_plugins.terminal")
...
local toggle = require("custom_plugins.toggle")
...
require("custom_plugins.writemode").setup()
