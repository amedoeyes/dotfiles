...
in
{
  config = lib.mkIf cfg.enable {
    ...
    xdg.configFile."cmus/eyes.theme".text = with config.theme.colors; ''
      set color_win_fg=${c10.ansi}
      ...
      set color_separator=${c04.ansi}
      set color_statusline_fg=${c10.ansi}
      set color_statusline_bg=${c00.ansi}
      set color_statusline_attr=bold
      set color_statusline_progress_fg=${c10.ansi}
      set color_statusline_progress_bg=${c00.ansi}
      set color_statusline_progress_attr=default
      set color_titleline_fg=${c10.ansi}
      set color_titleline_bg=${c00.ansi}
      set color_titleline_attr=bold
      set color_cmdline_fg=${c10.ansi}
      set color_cmdline_bg=${c00.ansi}
      set color_cmdline_attr=default
      set color_error=${c10.ansi}
      set color_info=${c10.ansi}
    '';
