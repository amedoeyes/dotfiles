        ...
        extraConfig =
          let
            ...
            icons = ''
              ...
              set classify+=" ::.bash_profile,,.bashrc,,.clang-format,,.clang-tidy,,.ds_store,,.gitconfig,,.luacheckrc,,.luaurc,,.pylintrc,,.zprofile,,.zshenv,,.zshrc,,Directory.Build.props,,Directory.Build.targets,,Directory.Packages.props,,config::"
              set classify+="󰓆 ::.codespellrc::"
              set classify+=" ::.condarc::"
              ...
              set classify+=" ::.pnpmfile.cjs,,pnpm-lock.yaml,,pnpm-workspace.yaml::"
              set classify+="󰛢 ::.pre-commit-config.yaml::"
              ...
              set classify+=" ::AUTHORS,,AUTHORS.txt::"
              set classify+=" ::FreeCAD.conf::"
              set classify+=" ::Gemfile,,brewfile,,rakefile::"
              ...
              set classify+=" ::bun.lock,,bun.lockb::"
              ...
              set classify+=" ::hypridle.conf,,hyprland.conf,,hyprlandd.conf,,hyprlock.conf,,hyprpaper.conf,,hyprsunset.conf,,xdph.conf::"
              set classify+="󰗊 ::i18n.config.js,,i18n.config.ts::"
              set classify+=" ::i3blocks.conf,,i3status.conf::"
              set classify+=" ::index.theme::"
              ...
              set classify+=" ::next.config.cjs,,next.config.js,,next.config.ts::"
              set classify+=" ::platformio.ini::"
              set classify+=" ::playwright.config.cjs,,playwright.config.cts,,playwright.config.js,,playwright.config.mjs,,playwright.config.mts,,playwright.config.ts::"
              set classify+=" ::pom.xml::"
              set classify+=" ::prisma.config.mts,,prisma.config.ts::"
              set classify+=" ::procfile::"
              set classify+=" ::py.typed::"
              set classify+="󰂺 ::readme,,readme.md::"
              set classify+=" ::rmd::"
              ...
              set classify+=" ::vite.config.cjs,,vite.config.cts,,vite.config.js,,vite.config.mjs,,vite.config.mts,,vite.config.ts,,vitest.config.cjs,,vitest.config.cts,,vitest.config.js,,vitest.config.mjs,,vitest.config.mts,,vitest.config.ts::"
              set classify+="󰕼 ::vlcrc::"
              set classify+="󰜫 ::webpack::"
              set classify+=" ::weston.ini::"
              set classify+=" ::wrangler.jsonc,,wrangler.toml::"
              ...
              set classify+=" ::Development/::"
              set classify+=" ::Documents/::"
              set classify+=" ::Downloads/::"
              set classify+=" ::Library/::"
              set classify+=" ::Movies/,,Videos/::"
              set classify+=" ::Music/::"
              set classify+=" ::Pictures/::"
              set classify+=" ::Public/::"

              set classify+=" ::*.3gp,,*.cast,,*.m4v,,*.mkv,,*.mov,,*.mp4,,*.ogv,,*.ogx,,*.webm,,*.wmv::"
              set classify+="󰆧 ::*.3mf,,*.fbx,,*.obj,,*.ply,,*.stl,,*.wrl,,*.wrz::"
              set classify+=" ::*.7z,,*.bz,,*.bz2,,*.bz3,,*.gz,,*.rar,,*.tgz,,*.txz,,*.xz,,*.zip,,*.zst::"
              set classify+="󰡨 ::*.Dockerfile,,*.dockerignore::"
              set classify+="󰟔 ::*.R,,*.r::"
              set classify+=" ::*.a,,*.dll,,*.lib,,*.so::"
              set classify+=" ::*.aac,,*.aif,,*.aiff,,*.ape,,*.flac,,*.m4a,,*.mp3,,*.oga,,*.ogg,,*.opus,,*.pcm,,*.spx,,*.wav,,*.wma,,*.wv,,*.wvc::"
              set classify+=" ::*.ada,,*.adb,,*.ads,,*.gpr::"
              set classify+=" ::*.ai::"
              set classify+=" ::*.android,,*.apk::"
              set classify+=" ::*.apl,,*.bqn::"
              ...
              set classify+=" ::*.astro::"
              set classify+=" ::*.avif,,*.bmp,,*.gif,,*.ico,,*.jpeg,,*.jpg,,*.jxl,,*.png,,*.webp::"
              set classify+=" ::*.awk,,*.csh,,*.fish,,*.ksh,,*.sh,,*.zsh::"
              set classify+=" ::*.azcli::"
              set classify+="󰁯 ::*.bak::"
              set classify+=" ::*.bash::"
              set classify+=" ::*.bat,,*.cfg,,*.conf,,*.ini,,*.yaml,,*.yml::"
              ...
              set classify+=" ::*.feature::"
              set classify+=" ::*.fnl::"
              set classify+=" ::*.fodg,,*.odg::"
              set classify+=" ::*.fodp,,*.odp::"
              set classify+=" ::*.fods,,*.ods::"
              set classify+=" ::*.fodt,,*.odt::"
              set classify+=" ::*.frag,,*.geom,,*.glsl,,*.vert::"
              ...
              set classify+="󰈧 ::*.ppt,,*.pptx::"
              set classify+=" ::*.prisma::"
              set classify+=" ::*.pro::"
              set classify+="󰨊 ::*.ps1,,*.psd1,,*.psm1::"
              set classify+=" ::*.psb,,*.psd::"
              set classify+="󰷖 ::*.pub::"
              set classify+=" ::*.pxd,,*.pxi,,*.py,,*.pyc,,*.pyd,,*.pyi,,*.pyo,,*.pyw,,*.pyx::"
              ...
              set classify+=" ::*.scad::"
              set classify+="󰘧 ::*.scm,,*.sig,,*.signature,,*.sml::"
              set classify+=" ::*.sln,,*.slnx,,*.suo,,*.vsix::"
              set classify+=" ::*.sol::"
              set classify+=" ::*.spec.js,,*.spec.jsx,,*.spec.ts,,*.spec.tsx,,*.test.js,,*.test.jsx,,*.test.ts,,*.test.tsx::"
              set classify+=" ::*.stories.js,,*.stories.jsx,,*.stories.mjs,,*.stories.svelte,,*.stories.ts,,*.stories.tsx,,*.stories.vue::"
              set classify+=" ::*.styl::"
              set classify+=" ::*.sublime::"
              set classify+="󰍛 ::*.sv,,*.svh,,*.v,,*.vh,,*.vhd,,*.vhdl::"
              set classify+=" ::*.svelte::"
              set classify+="󰜡 ::*.svg,,*.svgz::"
              set classify+=" ::*.swift,,*.xcplayground::"
              set classify+="󰛓 ::*.tbc,,*.tcl::"
              set classify+=" ::*.templ,,*.tmpl::"
